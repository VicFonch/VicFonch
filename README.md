...
class VictorFonteChavez(SoftwareDeveloper, MLEngineer):
  ...
  def __init__(self):
    ...
    self.username = "VicFonch";
    self.location = "Guanajuato, Mexico";
    self.mail = "vmfontech@gmail.com";
    self.web = "In process";
    self.linkedin = "https://www.linkedin.com/in/vicfonch"
  
  def __str__(self):
    return self.name

if __name__ == '__main__':
    me = VictorFonteChavez()
    print(me) # 😀 happy to connect!
```
...
<p>
  <a href="https://skillicons.dev">
    ...
    <img src="https://skills-icons.vercel.app/api/icons?i=huggingface" />
  </a>
</p>
